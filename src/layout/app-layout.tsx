...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['healthcare-provider'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Playlist', path: '/playlists', entity: 'playlist', service: AccessServiceEnum.PROJECT, icon: FiMusic },
    { name: 'Session', path: '/sessions', entity: 'session', service: AccessServiceEnum.PROJECT, icon: FiClock },
    { name: 'Tip', path: '/tips', entity: 'tip', service: AccessServiceEnum.PROJECT, icon: FiInfo },
